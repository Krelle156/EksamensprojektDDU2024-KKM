...
public class Infantry : Mobile
{
    ...
    {
        weapon.Fire(((Vector2)(transform.position - target.position)).magnitude, 5f + MapGenerator.terraindata[(int)target.position.x, (int)target.position.y].GetTerrainModifier());
    }
    void PickUpGun() {
